...
set encoding utf8
load "styles.inc"
set output "lmbench_dynamic.eps"
...
set ytics font ",16"
set ylabel "Tput (KOPs/s)" font ",16" offset 1.5,0
...
plot\
	...
	'data/dynamic/lmbench/intel-4threads/intel_all.csv' using 1:2 notitle 'i-all' with lines ls 2006,\
	'' every 1 using 1:2  notitle '' with points ls 2006, \
  	'data/dynamic/lmbench/zc.csv' using 1:2 notitle 'zc' with lines ls 2004, \
	'' every 1 using 1:2  notitle '' with points ls 2004, \
    'data/dynamic/lmbench/no_sl.csv' using 1:2 notitle 'no_sl' with lines ls 2005, \
	'' every 1 using 1:2  notitle '' with points ls 2005, \
	'data/dynamic/lmbench/intel-4threads/intel_read.csv' using 1:2 notitle 'i-read' with lines ls 2001,\
	'' every 1 using 1:2  notitle '' with points ls 2001, \
	'data/dynamic/lmbench/intel-4threads/intel_write.csv' using 1:2 notitle 'i-write' with lines ls 2002,\
...
set title "(a) CPU % usage" font "Helvetica-bold,13" offset 0,1
...
plot\
	...
	f(x) w lp ls 2001 title "i-read",\
	f(x) w lp ls 2002 title "i-write",\
	'data/dynamic/lmbench/intel-4threads/intel_all.csv' using 1:4 notitle 'i-all' with lines ls 2006,\
	'' every 1 using 1:4  notitle '' with points ls 2006, \
  	'data/dynamic/lmbench/zc.csv' using 1:4 notitle 'zc' with lines ls 2004, \
	'' every 1 using 1:4  notitle '' with points ls 2004, \
    'data/dynamic/lmbench/no_sl.csv' using 1:4 notitle 'no_sl' with lines ls 2005, \
	'' every 1 using 1:4  notitle '' with points ls 2005, \
	'data/dynamic/lmbench/intel-4threads/intel_read.csv' using 1:4 notitle 'i-fread' with lines ls 2001,\
	'' every 1 using 1:4  notitle '' with points ls 2001, \
	'data/dynamic/lmbench/intel-4threads/intel_write.csv' using 1:4 notitle 'i-fwrite' with lines ls 2002,\
	'' every 1 using 1:4  notitle '' with points ls 2002

	

!epstopdf "lmbench_dynamic.eps"
!rm "lmbench_dynamic.eps"
quit