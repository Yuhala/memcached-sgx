...
set encoding utf8
load "styles.inc"
set output "lmbench_read_cpu.eps"
...
plot\
	'data/dynamic/lmbench/intel-2threads/reader/intel_all.csv' using 1:4 title 'i-all' w lp ls 2006,\
	'data/dynamic/lmbench/intel-2threads/reader/zc.csv' using 1:4 title 'zc' w lp ls 2004, \
	'data/dynamic/lmbench/no_sl_reader.csv' using 1:4 notitle 'no_sl' w lp ls 2005, \
	'data/dynamic/lmbench/intel-2threads/reader/intel_read.csv' using 1:4 title 'i-read' w lp ls 2001,\
	'data/dynamic/lmbench/intel-2threads/reader/intel_write.csv' using 1:4 title 'i-write' w lp ls 2002,\
...
#set yrange [0:1000000]
plot\
	'data/dynamic/lmbench/intel-4threads/reader/intel_all.csv' using 1:4 title 'i-all' w lp ls 2006,\
	'data/dynamic/lmbench/intel-4threads/reader/zc.csv' using 1:4 title 'zc' w lp ls 2004, \
	'data/dynamic/lmbench/no_sl_reader.csv' using 1:4 notitle 'no_sl' w lp ls 2005, \
	'data/dynamic/lmbench/intel-4threads/reader/intel_read.csv' using 1:4 title 'i-read' w lp ls 2001,\
	'data/dynamic/lmbench/intel-4threads/reader/intel_write.csv' using 1:4 title 'i-write' w lp ls 2002,\
		

!epstopdf "lmbench_read_cpu.eps"
!rm "lmbench_read_cpu.eps"
quit