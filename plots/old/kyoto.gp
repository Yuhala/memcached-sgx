...
#set logscale y 10
#set ytics ("10^{-6}" 0.0000010,"10^{-5}" 0.00001,"10^{-4}" 0.0001,"10^{-3}" 0.001,"10^{-2}" 0.01,"10^{-1}" 0.1,"10^{0}" 1,"10^{1}" 10) offset 0.5,0
...
#------------------------------------------Plots-------------------------------------------------
set title "(a) SET Latency (2 writers)" font "Helvetica-bold,13" offset 0,1
...
plot\
	...
	'' every 1 using 1:2  notitle '' with points ls 2006, \
  	'data/kyoto/zc_1u.csv' using 1:2 notitle 'zc' with lines ls 2004, \
...
set ylabel "Avg. Throughput (Kops/s)" font ",16" offset 1.5,0
set ytics("0.1" 100,"0.2" 200, "0.3" 300, "0.4" 400, "0.5" 500)
set ytics font ",16"
...
plot\
	...
	f(x) w lp ls 2004 title "zc",\
    f(x) w lp ls 2005 title "no-sl",\
	'data/kyoto/intel.csv' using 1:3 notitle 'intel' with lines ls 2006,\
	'' every 1 using 1:3  notitle '' with points ls 2006, \
  	'data/kyoto/zc_1u.csv' using 1:3 notitle 'zc' with lines ls 2004, \
	'' every 1 using 1:3  notitle '' with points ls 2004, \
    'data/kyoto/no_sl.csv' using 1:3 notitle 'no_sl' with lines ls 2005, \
