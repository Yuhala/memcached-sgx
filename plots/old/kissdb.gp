...
plot\
	...
	'data/kissdb/intel.csv' using 1:2 notitle 'intel' with lines ls 2006,\
	'' every 1 using 1:2  notitle '' with points ls 2006, \
  	'data/kissdb/zc_1u.csv' using 1:2 notitle 'zc-1u' with lines ls 2004, \
	'' every 1 using 1:2  notitle '' with points ls 2004, \
    'data/kissdb/no_sl.csv' using 1:2 notitle 'no_sl' with lines ls 2005, \
...
plot\
	...
	f(x) w lp ls 2004 title "zc",\
    f(x) w lp ls 2005 title "no-sl",\
	'data/kissdb/intel.csv' using 1:3 notitle 'intel' with lines ls 2006,\
	'' every 1 using 1:3  notitle '' with points ls 2006, \
  	'data/kissdb/zc_1u.csv' using 1:3 notitle 'zc' with lines ls 2004, \
	'' every 1 using 1:3  notitle '' with points ls 2004, \
    'data/kissdb/no_sl.csv' using 1:3 notitle 'no_sl' with lines ls 2005, \
