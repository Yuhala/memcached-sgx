 ...
 */
   ...
   */
     ...
     */
      bool set_value(const char *vbuf, size_t vsiz, bool step = false)
      {
        ...
        {
        public:
          explicit VisitorImpl(const char *vbuf, size_t vsiz) : vbuf_(vbuf), vsiz_(vsiz), ok_(false) {}
          bool ok() const
          {
            return ok_;
          }
     ...
     */
      bool get(std::string *key, std::string *value, bool step = false)
      {
        ...
        {
        public:
          explicit VisitorImpl(std::string *key, std::string *value) : key_(key), value_(value), ok_(false) {}
          bool ok()
          {
            return ok_;
          }
   ...
   */
    bool append(const char *kbuf, size_t ksiz, const char *vbuf, size_t vsiz)
    {
      ...
      {
      public:
        explicit VisitorImpl(const char *vbuf, size_t vsiz) : vbuf_(vbuf), vsiz_(vsiz), nbuf_(NULL) {}
        ~VisitorImpl()
        {
          if (nbuf_)
            delete[] nbuf_;
   ...
   */
    double increment_double(const char *kbuf, size_t ksiz, double num, double orig = 0)
    {
      ...
      {
      public:
        explicit VisitorImpl(double num, double orig) : DECUNIT(1000000000000000LL), num_(num), orig_(orig), buf_() {}
        double num()
        {
          return num_;
        }
   ...
   */
             ...
             const char *ovbuf, size_t ovsiz, const char *nvbuf, size_t nvsiz)
    {
      ...
      {
      public:
        explicit VisitorImpl(const char *ovbuf, size_t ovsiz, const char *nvbuf, size_t nvsiz) : ovbuf_(ovbuf), ovsiz_(ovsiz), nvbuf_(nvbuf), nvsiz_(nvsiz), ok_(false) {}
        bool ok() const
        {
          return ok_;
        }
